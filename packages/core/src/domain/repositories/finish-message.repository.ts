 ...
 * round of a retrospective, for the export — the owner asked for the message to
 * be carried *per revision round*, so a document that folded them into one would
...
export type FinishMessageRepository = {
  ...
  /** The version in force for that round, or `undefined` if he left no word. */
