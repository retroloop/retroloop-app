 ...
 * a human field with everything that implies: the AI is refused at the use case
 * and the table's triggers back that up at L1, and reopening writes a new
 * version rather than editing the one that stands.
 *
