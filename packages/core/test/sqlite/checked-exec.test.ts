 ...
 *
 * The original five-case table was written up elsewhere and did not survive, so
 * this is the evidence itself rather than a copy of it: every case below was
 * run against bun 1.4.0 on a throwaway database and asserts what the driver
 * actually did.
 *
