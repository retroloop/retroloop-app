 ...
 * no CLI command exists for it (KC-0010). What matters for the test is that the
 * write lands from **a different process** against the same stage, exactly as the
 * server will do on the human's behalf in item 5.
 */
