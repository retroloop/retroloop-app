...
/**
 * The relative half of the diary's date rule — dates are relative when they are
 * not too far off — proved **here rather than in the browser**, and the reason is
 * a flake that nearly shipped.
 *
