 ...
 * right** (`r-menu-dropdown`): every menu item lives under a single dropdown in
 * the top right, built on the shadcn dropdown-menu primitive rather than on a
 * hand-rolled menu.
 *
 * **It lives in the shell rather than on the pages.** The loose links it replaces
 * were the dashboard's own — the records link, then the settings link, whose
