 ...
 * trail on the line below it (ux-brief 03, amended by the owner in session 11 —
 * *"The breadcrumbs shouldn't be in the top menu it should be somewhere below
 * it"*).
 *
 * **What the header holds is now exactly two things: what this product is, and
 * where else you can go** (retro-13 `r-menu-dropdown`). The theme toggle that
 ...
 * they have no rail to live in (`r-review-actions-pinned`, and the owner's iPad
 * ask in session 7) — the record for the dropdown is explicit that those stay
 * where earlier rulings put them, because what it consolidates is *global*
 * navigation. They are slots rather than components of their own because the
 ...
 *
 * **The measure is one measure, on every page and in every state** (owner,
 * session 7: *"The width of the home page is not consistent with the width of
 * the retro page"*). It used to be conditional: a `wide` prop the review page
 ...
 *
 * **The 128px this gained over session 9's 1408 all went to the rails**
 * (`r-wider-page-for-panels`, the owner: *"I think the max width should be even
 * wider and all of it should go to the left index panel and the right comments
 * panel"*). The reading column's cap did not move: 48rem is a typography ceiling
 ...
 * number.
 *
 * `mx-auto` is the other half of the owner's rule: past 1536 the page stops
