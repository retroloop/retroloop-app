 ...
 * retrospective — and it exists because labels and attributes are never
 ...
 * the rule generalises the way it was stated rather than being re-decided
 * per surface.
 *
 * The count recedes rather than disappearing at zero, which is `CountsBar`'s
 * rule elsewhere and the records filter's rule here: a vocabulary nobody has
